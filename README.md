# Выполнено Домашнее задание №11: Разработка и тестирование Ansible ролей и плейбуков
...
### В процессе сделано:
   ...
   Установлен vagrant
   Настроен vagrant для запуска двух виртуальных машин app и db
   Изменены роли и плейбуки в ansible
   Молекула в ДЗ безвозвратно устарела. Поэтому ничего не получилось в рамках методички.
